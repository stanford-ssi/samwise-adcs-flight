...
bool saturation_detection(linalg::vec<float, 3> &reaction_wheel_1, linalg::vec<float, 3> &reaction_wheel_2, linalg::vec<float, 3> &reaction_wheel_3, linalg::vec<float, 3> &reaction_wheel_4)
{
    /*
...
bool desaturation_detection(linalg::vec<float, 3> &reaction_wheel_1, linalg::vec<float, 3> &reaction_wheel_2, linalg::vec<float, 3> &reaction_wheel_3, linalg::vec<float, 3> &reaction_wheel_4)
{
    /*
    Inputs: Reaction wheel torques
...
linalg::vec<float, 3> calculate_magnetometer_dipole(slate_t *slate, linalg::vec<float, 3> &total_reaction_wheel_angular_momentum)
{
    /*
