...
#include "apps/adcs_app/states/detumble_state.h"
#include "apps/adcs_app/states/init_state.h"
#include "apps/adcs_app/states/safe_state.h"
#include "apps/adcs_app/states/test_state.h"
...
#ifdef FLIGHT
    if (slate->power_monitor_alive && slate->adcs_voltage < V_BATT_LOW_POWER)
    {
