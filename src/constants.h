...
constexpr float3 I_PRINCIPAL = {0.0237644, 0.0155789,
...
constexpr float3x3 PRINCIPAL_AXES_DCM = {
    ...
    {-0.017578342466487904, 0.999548738669219, 0.02435817934296709}}; // DCM from body to principal axes

constexpr quaternion Q_BODY_TO_PRINCIPAL = {0.268793, -0.644648, -0.665287, 0.263765}; // Quaternion from body to principal axes (scalar-last)

constexpr float3x3 I_BODY = {
 {0.01861, 0.00529, 0.0001439},
 {0.00529, 0.01833, 0.0000584709},
 {0.0001439, 0.0000584709, 0.01558}}; // Satellite inertia tensor in body frame [kg m^2] 
