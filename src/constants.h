...
// Spec sheet: https://www.faulhaber.com/fileadmin/Import/Media/EN_2610_B_DFF.pdf
// Reaction wheel MOI:
// This is the moment of inertia of the reaction wheel about its axis of rotation
// Same for all reaction wheels, irregardless of oriented axis
constexpr float REACTION_WHEEL_MOI = 7.90e-7; // [kg*m^2]
// Reaction wheel max angular momentum:
constexpr float MAX_REACTION_WHEEL_ANGULAR_MOMENTUM = (40000/60)*REACTION_WHEEL_MOI; // [kg*m^2/s]
