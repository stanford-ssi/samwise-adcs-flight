...
void software_uart_handle_rx_start(software_uart_t *uart)
{
    ...
    uart->rx_alarm_id = add_alarm_in_us(BIT_TIME_US + BIT_TIME_US / 2,
                                        software_uart_handle_rx, uart, false);
}
...
void software_uart_handle_tx_start(software_uart_t *uart)
{
    ...
    uart->tx_alarm_id =
        add_alarm_in_us(BIT_TIME_US, software_uart_handle_tx, uart, false);
...
{
    if (uart->rx_buffer_start == uart->rx_buffer_end)
        return 0;
