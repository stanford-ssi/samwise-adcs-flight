...
static void populate_tx(slate_t *slate)
{
    ...
    {
        slate->motor_telemetry_tx.reaction_wheels_enabled[i] = slate->reaction_wheels_enabled[i];
        slate->motor_telemetry_tx.w_reaction_wheels_requested[i] = slate->w_reaction_wheels_requested[i];
    }
...
sched_task_t reaction_wheel_task = {.name = "reaction_wheels",
                               .dispatch_period_ms =
